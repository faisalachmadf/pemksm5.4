...
class HalamanDepanController extends Controller
{
    ...
    {
        $data = [
            'banners' => header::Urutan()->take(4)->get(),
            'umums' => Berita::getDataByKat('Berita-Umum', 4)->get(),
            'daerahs' => Berita::getDataByKat('Berita-Urusan-Pemerintahan-Daerah', 6)->get(),
            'tatas' => Berita::getDataByKat('Berita-Tata-Pemerintahan', 6)->get(),
            'kerjasamas' => Berita::getDataByKat('Berita-Kerja-Sama', 6)->get(),
            ...
            'agendas' => Agenda::getData()->take(5)->get(),
