                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul class="multi-column-dropdown">
                                        <li><a href="/tkksd/Mitra-Kerjasama-Dalam-Negeri">Mitra Kerjasama Dalam Negeri</a></li>
                                        <li class="divider"></li>
                                        <li><a href="/tkksd/Mitra-Kerjasama-Luar-Negeri">Mitra Kerjasama Luar Negeri</a></li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                                    <ul class="multi-column-dropdown">
