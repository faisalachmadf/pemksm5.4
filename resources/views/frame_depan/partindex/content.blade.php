        ...
        <!-- Di isi dengan tabel beritas kategori berita umum -->
                        ...
                        <div class="world-news-grids">
                            ...
                            <div class="world-news-grid">
                                <div class="thumbnail">
                                    <img src="{{ asset('image/berita/thumbnail/'.$umum->gambar) }}" alt="{{ $umum->judul }}" class="img-responsive wp-post-image"/>
                                </div>
                                <a href="{{ route('Berita-Umum.show', $umum->slug) }}" class="wd">{{ $umum->judul }}</a>
                                {!! $umum->isi !!}
                            </div>
                            @endforeach
                            <br/><hr/>
                          ...
                          <h2 class="tittle"><i class="glyphicon glyphicon-certificate"> </i>Urusan Pemerintahan Daerah</h2>
                            ...
                            <div class="editor-pics">
                                ...
                                <div class="col-md-8 item-details">
                                    <h5 class="inner two"><a href="{{ route('Berita-Urusan-Pemerintahan-Daerah.show', $daerah->slug) }}">{{ $daerah->judul }}</a></h5>
                        ...
                        <div class="technology">
                          <h2 class="tittle"><i class="glyphicon glyphicon-certificate"> </i>Tata Pemerintahan</h2>
                            ...
                            <div class="editor-pics">
                                ...
                                <div class="col-md-8 item-details">
                                    <h5 class="inner two"><a href="{{ route('Berita-Tata-Pemerintahan.show', $tata->slug) }}">{{ $tata->judul }}</a></h5>
                        ...
                        <div class="technology">
                          <h2 class="tittle"><i class="glyphicon glyphicon-certificate"> </i>Kerja Sama</h2>
                            ...
                            <div class="editor-pics">
                                ...
                                <div class="col-md-8 item-details">
                                    <h5 class="inner two"><a href="{{ route('Berita-Kerja-Sama.show', $kerjasama->slug) }}">{{ $kerjasama->judul }}</a></h5>
