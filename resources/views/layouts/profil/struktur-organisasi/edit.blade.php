  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <!-- /.box-header -->
        <form class="form-horizontal" method="POST" action="{{ route('struktur-organisasi.update', @$pegawai->nip) }}" enctype="multipart/form-data">
          {{ csrf_field() }}
          {{ method_field('PUT') }}
          ...
          @if($pegawai)
            <div class="col-sm-5">
              <div class="form-group{{ $errors->has('nip') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="nip" name="nip" value="{{ old('nip', $pegawai->nip) }}" placeholder="NIP" required>
              ...
              <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="nama" name="nama" value="{{ old('nama', $pegawai->nama) }}" placeholder="Nama Pegawai" required>
                ...
                <div class="col-sm-8">
                  <select class="form-control" id="id_katbagian" name="id_katbagian" required>
                    ...
                    @foreach($katbagian as $bagian)
                      <option value="{{ $bagian->id }}" {{ old('id_katbagian', $pegawai->id_katbagian) == $bagian->id ? 'selected' : '' }}>{{ $bagian->name }}</option>
                    @endforeach
                  </select>
                ...
                <div class="col-sm-8">
                  <select class="form-control" id="id_katjabatan" name="id_katjabatan" required>
                    ...
                    @foreach($katjabatan as $jabatan)
                      <option value="{{ $jabatan->id }}" {{ old('id_katjabatan', $pegawai->id_katjabatan) == $jabatan->id ? 'selected' : '' }}>{{ $jabatan->name }}</option>
                    @endforeach
                  </select>
                ...
                <div class="col-sm-8">
                  <select class="form-control" id="id_katgolongan" name="id_katgolongan" required>
                    ...
                    @foreach($katgolongan as $golongan)
                      <option value="{{ $golongan->id }}" {{ old('id_katgolongan', $pegawai->id_katgolongan) == $golongan->id ? 'selected' : '' }}>{{ $golongan->name }}</option>
                    @endforeach
                  </select>
              ...
              <div class="form-group{{ $errors->has('mulaijabat') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                  <div class="input-group date">
                    ...
                    <input type="text" class="form-control datepicker" id="mulaijabat" name="mulaijabat" value="{{ old('mulaijabat', dateFormatIndo($pegawai->mulaijabat)) }}" placeholder="dd/mm/yyyy" required>
                  </div>
            ...
            <div class="col-sm-7">
              <div class="form-group{{ $errors->has('pendidikan') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" id="pendidikan" name="pendidikan" rows="10" placeholder="Pendidikan" required>{{ old('pendidikan', $pegawai->pendidikan) }}</textarea>
              ...
              <div class="form-group{{ $errors->has('riwayatkerja') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" id="riwayatkerja" name="riwayatkerja" rows="10" placeholder="Riwayat Kerja" required>{{ old('riwayatkerja', $pegawai->riwayatkerja) }}</textarea>
