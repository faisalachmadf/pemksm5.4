  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('lppd.index') }}">lppd Biro</a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <!-- /.box-header -->
        <form class="form-horizontal" method="POST" action="{{ route('lppd.update', @$lppd->slug) }}" enctype="multipart/form-data">
          {{ csrf_field() }}
          {{ method_field('PUT') }}
          ...
          @if($lppd)
            <div class="form-group{{ $errors->has('judul') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-4">
                <input type="text" class="form-control" id="judul" name="judul" value="{{ old('judul', $lppd->judul) }}" placeholder="Judul" required>
            ...
            <div class="form-group{{ $errors->has('tanggal') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-4">
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control datepicker" id="tanggal" name="tanggal" value="{{ old('tanggal', dateFormatIndo($lppd->tanggal)) }}" placeholder="dd/mm/yyyy" required>
                </div>
            ...
            <div class="form-group{{ $errors->has('isi') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-12">
                <textarea class="form-control" id="isi" name="isi" placeholder="Isi" required>{{ old('isi', $lppd->isi) }}</textarea>
