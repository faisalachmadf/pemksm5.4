    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
          <a href="{{ route('katmitra.create') }}" class="btn btn-primary">
        ...
        <div class="box-body">
          ...
          @endif
          <table id="katmitras-table" class="table table-bordered table-striped" width="100%">
            <thead>
              <tr>
                <th>No</th>
                <th>Nama Mitra</th>
...
@section('customJs')
  <script type="text/javascript">
    $(function() {
      ...
      createDatatables('#katmitras-table', '{!! route('katmitra.datatables') !!}', columns);
    });
  </script>
@endsection
