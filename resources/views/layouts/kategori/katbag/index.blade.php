    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
          <a href="{{ route('kategori-bagian.create') }}" class="btn btn-primary">
        ...
        <div class="box-body">
          ...
          @endif
          <table id="katbags-table" class="table table-bordered table-striped" width="100%">
            <thead>
              <tr>
                <th>No</th>
                <th>Nama</th>
...
@section('customJs')
  <script type="text/javascript">
    $(function() {
      ...
      createDatatables('#katbags-table', '{!! route('kategori-bagian.datatables') !!}', columns);
    });
  </script>
@endsection
