    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
          <a href="{{ route('katmitraln.create') }}" class="btn btn-primary">
        ...
        <div class="box-body">
          ...
          @endif
          <table id="katmitralns-table" class="table table-bordered table-striped" width="100%">
            <thead>
              <tr>
                <th>No</th>
                <th>Nama Mitra</th>
...
@section('customJs')
  <script type="text/javascript">
    $(function() {
      ...
      createDatatables('#katmitralns-table', '{!! route('katmitraln.datatables') !!}', columns);
    });
  </script>
@endsection
