    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
          <a href="{{ route('kategori-hukum.create') }}" class="btn btn-primary">
        ...
        <div class="box-body">
          ...
          @endif
          <table id="kathukums-table" class="table table-bordered table-striped" width="100%">
            <thead>
              <tr>
                <th>No</th>
                <th>Nama</th>
...
@section('customJs')
  <script type="text/javascript">
    $(function() {
      ...
      createDatatables('#kathukums-table', '{!! route('kategori-hukum.datatables') !!}', columns);
    });
  </script>
@endsection
