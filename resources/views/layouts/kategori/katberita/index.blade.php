    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          @endif
          <table id="katberitas-table" class="table table-bordered table-striped" width="100%">
            <thead>
              <tr>
                <th>No</th>
                <th>Nama</th>
...
@section('customJs')
  <script type="text/javascript">
    $(function() {
      ...
      createDatatables('#katberitas-table', '{!! route('kategori-berita.datatables') !!}', columns);
    });
  </script>
@endsection
