...
<form action="/pemksm5.4/public/adminpanel/aplikasi/{{$aplikasis->id}}" method="POST" enctype="multipart/form-data">
  <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Ubah Aplikasi</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="judul" class="form-control" value="{{$aplikasis->judul}}">
                  <span class="required">{{ ($errors->has('judul')) ? $errors->first('judul') : ''}}</span>
                </div>
                <div class="form-group">
                  <label>Link Aplikasi<span class="required">*</span></label>
                  <input type="text" name="link" class="form-control" value="{{$aplikasis->link}}">
                ...
                <div class="form-group">
                  ...
                  <img src="{{ asset('image/beranda/'. $aplikasis->gambar) }}" class="img-responsive"  width="200px">
                  <br/>
