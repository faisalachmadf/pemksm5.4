                ...
                <tr>
                  ...
                  <td>  
                   <img src="{{ asset('image/beranda/'. $link->gambar) }}" class="img-responsive"  width="200px" height="200px"> </td>
                    ...
                    <td>
                        <a href="/pemksm5.4/public/adminpanel/link/{{$link->id}}" class="btn btn-info">
                          <i class="fa fa-book"></i>
                        <span>Detil</span></a>
                        
                      
                        <a href="/pemksm5.4/public/adminpanel/link/{{$link->id}}/edit" class="btn btn-warning">
                            <i class="fa fa-edit"></i>
                        <span>Edit</span></a>

                        <form  action="/pemksm5.4/public/adminpanel/link/{{$link->id}}" method="post">
