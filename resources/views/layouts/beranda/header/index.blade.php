                ...
                <tr>
                  ...
                  <td>  
                   <img src="{{ asset('image/beranda/'. $header->gambar) }}" class="img-responsive"  width="200px" height="200px"> </td>
                    ...
                    <td>
                        <a href="/adminpanel/header/{{$header->id}}" class="btn btn-info">
                          <i class="fa fa-book"></i>
                        <span>Detil</span></a>
                        
                      
                        <a href="/adminpanel/header/{{$header->id}}/edit" class="btn btn-warning">
                            <i class="fa fa-edit"></i>
                        <span>Edit</span></a>

                        <form  action="/adminpanel/header/{{$header->id}}" method="post">
