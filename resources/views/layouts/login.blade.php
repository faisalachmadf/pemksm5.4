...
<head>
  ...
  <title>Biro Pemerintahan dan Kerja Sama Provinsi Jawa Barat | Log in</title>
...
<body class="hold-transition login-page" style="background: url(/temafrontend/images/background.jpg);">
<div class="login-box">
  <div class="login-logo">
    <a href="{{ route('admin.dashboard') }}"><b><font color="white">  Biro Pemerintahan dan Kerja Sama Provinsi Jawa Barat</font></b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">PemKSM Login</p>
    @if($errors->has('credential'))
        <div class="alert alert-danger alert-dismissible" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            <span>{{ $errors->first('credential') }}</span>
        </div>
    @endif
    ...
    <form method="POST" action="{{ route('auth.login') }}">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="credential" value="{{ old('credential') }}" placeholder="Username/Email" required>
    ...
    <!-- <a href="{{ route('reset') }}">I forgot my password</a><br>
