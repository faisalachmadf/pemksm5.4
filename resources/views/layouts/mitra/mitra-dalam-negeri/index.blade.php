    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
          <a href="{{ route('mitra-dalam-negeri.create') }}" class="btn btn-primary">
        ...
        <div class="box-body">
          ...
          @endif
          <table id="mitra-dalam-negeris-table" class="table table-bordered table-striped" width="100%">
            <thead>
              <tr>
                <th>No</th>
                <th>Nama Mitra</th>
  ...
  <script type="text/javascript">
    $(function() {
      var columns = [
        ...
        { data: 'katmitra.name', name: 'katmitra.name' },
        { data: 'gambar', name: 'gambar', orderable: false, searchable: false, width: '20%' },
        { data: 'user', name: 'user.username' },
        { data: 'action', name: 'action', orderable: false, searchable: false, width: '15%' }
      ];

      createDatatables('#mitra-dalam-negeris-table', '{!! route('mitra-dalam-negeri.datatables') !!}', columns);
    });
  </script>
@endsection
