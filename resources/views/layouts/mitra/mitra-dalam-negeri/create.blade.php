  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('mitra-dalam-negeri.index') }}">Mitra Kerjasama Dalam</a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <!-- /.box-header -->
        <form class="form-horizontal" method="POST" action="{{ route('mitra-dalam-negeri.store') }}" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="box-body">
            ...
            <div class="form-group{{ $errors->has('id_katmitra') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-4">
                <select class="form-control" id="id_katmitra" name="id_katmitra" required>
                  ...
                  @foreach($katmitra as $mitradn)
                    <option value="{{ $mitradn->id }}" {{ old('id_katmitra') == $mitradn->id ? 'selected' : '' }}>{{ $mitradn->name }}</option>
                  @endforeach
                </select>
