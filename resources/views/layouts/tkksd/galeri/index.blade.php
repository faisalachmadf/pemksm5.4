    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
          <a href="{{ route('galeri-tkksd.create') }}" class="btn btn-primary">
        ...
        <div class="box-body">
          ...
          @endif
          <table id="galeri-tkksds-table" class="table table-bordered table-striped" width="100%">
            <thead>
              <tr>
                <th>No</th>
                <th></th>
...
@section('customJs')
  <script type="text/javascript">
    $(function() {
      ...
      createDatatables('#galeri-tkksds-table', '{!! route('galeri-tkksd.datatables') !!}', columns, 'desc');
    });
  </script>
@endsection
