  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <!-- /.box-header -->
        <form class="form-horizontal" method="POST" action="{{ route('tkksd.update', @$tkksd->slug) }}" enctype="multipart/form-data">
          {{ csrf_field() }}
          {{ method_field('PUT') }}
          <input type="hidden" name="id" value="{{ @$tkksd->id }}">
          <div class="box-body">
          @if($tkksd)
            <div class="form-group{{ $errors->has('judul') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-4">
                <input type="text" class="form-control" id="judul" name="judul" value="{{ old('judul', $tkksd->judul) }}" placeholder="Judul" required>
            ...
            <div class="form-group{{ $errors->has('tanggal') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-4">
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control datepicker" id="tanggal" name="tanggal" value="{{ old('tanggal', dateFormatIndo($tkksd->tanggal)) }}" placeholder="dd/mm/yyyy" required>
                </div>
            ...
            <div class="form-group{{ $errors->has('isi') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-12">
                <textarea class="form-control" id="isi" name="isi" placeholder="Isi" required>{{ old('isi', $tkksd->isi) }}</textarea>
