        ...
        <form class="form-horizontal" method="POST" action="{{ route('user.update', $user->username) }}">
          ...
          <div class="box-body">
            <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-4">
                <input type="text" class="form-control" id="username" name="username" value="{{ old('username', $user->username) }}" placeholder="Username" required>
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-4">
                <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $user->email) }}" placeholder="email@domain.com" required>
            ...
            <div class="form-group{{ $errors->has('password_lama') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-4">
                <input type="password" class="form-control" id="password_lama" name="password_lama" value="" placeholder="Password Lama">
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-4">
                <input type="password" class="form-control" id="password" name="password" value="{{ old('password') }}" placeholder="Password Baru">
                <small>Minimal 8 karakter (Kosongkan jika tidak ingin diubah)</small>
            ...
            <div class="form-group{{ $errors->has('konfirmasi_password') ? ' has-error' : '' }}">
              <label for="konfirmasi_password" class="col-sm-4 control-label">Konfirmasi Password Baru :</label>

              <div class="col-sm-4">
                <input type="password" class="form-control" id="konfirmasi_password" name="konfirmasi_password" value="{{ old('password') }}" placeholder="Konfirmasi Password Baru">
            ...
            <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-4">
                <input type="text" class="form-control" id="first_name" name="first_name" value="{{ old('first_name', $user->first_name) }}" placeholder="Nama Depan">
            ...
            <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-4">
                <input type="text" class="form-control" id="last_name" name="last_name" value="{{ old('last_name', $user->last_name) }}" placeholder="Nama Belakang">
