          ...
          @if($kerjasama)
            <div class="col-sm-6">
              <div class="form-group">
                <label for="katdn" class="col-sm-4 control-label">Kategori Kerjasama :</label>

                <div class="col-sm-8">
                  <p class="form-control-static">{{ $kerjasama->katdn->name }}</p>
                </div>
              </div>
              <div class="form-group">
                <label for="katjenisdn" class="col-sm-4 control-label">Kategori Jenis Kerjasama :</label>

                <div class="col-sm-8">
                  <p class="form-control-static">{{ $kerjasama->katjenisdn->name }}</p>
                </div>
              </div>
              <div class="form-group">
