  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <!-- /.box-header -->
        <form class="form-horizontal" method="POST" action="{{ route('kerjasama-dalam-negeri.update', @$kerjasama->slug) }}" enctype="multipart/form-data">
          {{ csrf_field() }}
          {{ method_field('PUT') }}
          ...
          @if($kerjasama)
              ...
              <div class="form-group{{ $errors->has('id_katdn') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                  <select class="form-control" id="id_katdn" name="id_katdn" required>
                    ...
                    @foreach($katdn as $dn)
                      <option value="{{ $dn->id }}" {{ old('id_katdn', $kerjasama->id_katdn) == $dn->id ? 'selected' : '' }}>{{ $dn->name }}</option>
                    @endforeach
                  </select>
                ...
                <div class="col-sm-8">
                  <select class="form-control" id="id_katjenisdn" name="id_katjenisdn" required>
                    ...
                    @foreach($katjenisdn as $jenisdn)
                      <option value="{{ $jenisdn->id }}" {{ old('id_katjenisdn', $kerjasama->id_katjenisdn) == $jenisdn->id ? 'selected' : '' }}>{{ $jenisdn->name }}</option>
                    @endforeach
                  </select>
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group{{ $errors->has('gambar') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                  {!! generateImagePath('kerjasama-dalam-negeri', $kerjasama->gambar, $kerjasama->judul) !!}
