	    ...
	    <div class="container">
              ...
              <div class="col-md-8 mag-innert-left">
	                            ...
	                            <div class="banner-bottom-left-grids">
								  ...
								  <hr/><h6>Bagikan :</h6><br/>
                                       <a href="whatsapp://send?text={{ route('Tugas-Pokok-dan-Fungsi.index') }}" 
										data-action="share/whatsapp/share">
										<img src='/temafrontend/images/wa.png' alt='' width='40' height='40'></a>
                                    <a rel='nofollow' style="margin-right: 5px;" target="_blank" href='https://www.facebook.com/sharer.php?u={{ route('Tugas-Pokok-dan-Fungsi.index') }}'>
                                     <img src='/temafrontend/images/logofb.png' alt='' width='50' height='50'></a>
                                    <a rel='nofollow' style="margin-right: 5px;" target="_blank" href='https://twitter.com/share?url={{ route('Tugas-Pokok-dan-Fungsi.index') }}'>
                                   <img src='/temafrontend/images/logotwitter.png' alt='' width='40' height='40'></a>
                                    <a rel='nofollow' style="margin-right: 5px;" target="_blank" href='https://plus.google.com/share?url={{ route('Tugas-Pokok-dan-Fungsi.index') }}'>
